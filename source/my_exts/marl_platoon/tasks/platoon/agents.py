...
class PlatoonAlgorithmCfg:
    ...
    happo_ams_enabled: bool = False
    happo_ams_lr: float = 1.0e-4
    happo_ams_tau: float = 0.01
    happo_ams_num_neighbors: int = 8
    happo_ams_neighborhood_radius: float = 0.25
    happo_ams_refresh_every: int = 1000
    happo_ams_huber_beta: float = 0.3
    happo_ams_q_epochs: int = 1
    happo_ams_num_mini_batches: int = 16
    happo_ams_max_grad_norm: float = 0.5
    happo_ams_target_clip: float = 100.0
    happo_ams_eval_chunk_size: int = 8192
    happo_ams_advantage_weight: float = 0.10
    happo_ams_warmup_updates: int = 50
    happo_ams_ramp_updates: int = 100
